...
## [项目地址](https://github.com/wqlyy/gulp-template)
* 如对你有帮助，希望给个Star ！哈哈哈！！
```
git clone https://github.com/wqlyy/gulp-template.git
```
...
* [项目地址](https://github.com/wqlyy/gulp-template) 如对你有帮助，希望给个Star ！哈哈哈！！
